...
import peluqueria from "../assets/imgs/services/peluqueria.webp";
...
//     content: (
//       <>
//         <div className="place-self-center mask-paint-1">
//           <img
//             src={peluqueria}
//             alt="cortando el pelo en el local"
//             className="w-full max-w-sm not-prose"
//           />
//         </div>
...
//     content: (
//       <>
//         <div className="rounded-md overflow-hidden place-self-center w-fit">
//           <img
//             src={barber}
...
//           Se utilizan técnicas de alta calidad para crear un resultado natural y
//           duradero. Con nuestra pigmentación puedes:
//         </p>
...
//     title: "Precios",
//     className:
//       "w-full max-w-[92vw] md:col-span-2 md:w-fit md:place-self-center lg:col-span-1 h-full",
//     content: (
//       <>
...
//         <i>*Consulte por otros servicios.</i>
//       </>
//     ),
//   },
...
//     className:
//       "text-center break-all md:col-span-2 md:w-fit md:place-self-center lg:col-span-1",
//     content: (
//       <>
...
//         <h3 className="uppercase font-[western] font-normal">
...
export default function Services() {
  return (
    <section id="servicios" className="section space-y-4">
      <motion.article
        className="flex flex-col items-center gap-2 lg:flex-row p-3 md:p-4"
        variants={{
          hidden: {},
          visible: {
            transition: {
      ...
      >
        <div className="relative max-w-lg lg:min-w-sm m-2 z-10">
          ...
          <div className="drop-shadow-[0_0_8px] drop-shadow-amber-400 relative z-20">
            <motion.div
              className="absolute inset-0 mask-paint-1 mask-paint-animate bg-contain bg-center bg-[url('./assets/imgs/services/peluqueria.webp')]"
              variants={{
      ...
      >
        <motion.div
          className="w-fit max-w-md lg:min-w-sm m-2 rounded-lg overflow-hidden"
          variants={{
            hidden: { opacity: 0 },
            visible: { opacity: 1 },
          }}
      ...
      >
        ...
        <i>*Consulte por otros servicios. Los precios pueden variar.</i>
      </motion.article>
